...
- 🛠️ **Menu de zone de notification** : Accès rapide aux commandes principales via une icône dans la barre des tâches.
...
- **Langage Système** : [Rust](https://www.rust-lang.org/) - Pour la logique métier et l'accès hardware performant.
